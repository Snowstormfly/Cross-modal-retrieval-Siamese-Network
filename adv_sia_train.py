...
# data folder
# data_dir = "../data/a"
data_dir = r"E:\论文数据集\SBIR\SBRSIR-master\dataset\RSketch"
...
saving_model_name = r'E:\论文数据集\SBIR\SBRSIR-master\models'
...
model_pretrained.load_state_dict(torch.load(r"E:\论文数据集\SBIR\SBRSIR-master\codes\resnet50-19c8e357.pth"))    # weights of imagenet
...
optimizer_dis = optim.Adam(model_dis.parameters(), lr=0.0002, betas=(0.5, 0.999))
